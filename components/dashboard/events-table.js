...
class ToBeAllocatedTable extends React.Component {
  state = {
    ...
    selected: [],
    data: [
      createData('Timetamp1', 'Event1', 'Pending'),
      createData('Timetamp2', 'Event2', 'Pending'),
      createData('Timetamp3', 'Event3', 'Pending'),
      createData('Timetamp4', 'Event6', 'Pending'),
      createData('Timetamp5', 'Event5', 'Completed'),
    ],
    page: 0,
    rowsPerPage: 5,
  };
