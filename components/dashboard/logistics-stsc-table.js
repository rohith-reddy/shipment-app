...
let counter = 0;
function createData(crane, currentPosition, portOfOperation, scheduledMaintenance, currentStatus, action, remarks) {
  counter += 1;
  return { id: counter, crane, currentPosition, portOfOperation, scheduledMaintenance, currentStatus, action, remarks };
}
...
const rows = [
  ...
  { id: '4', numeric: false, disablePadding: false, label: 'Port Of Operation' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{n.portOfOperation}</TableCell>
