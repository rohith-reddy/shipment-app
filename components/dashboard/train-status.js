...
const rows = [
  ...
  { id: 'Train Arrival Time', numeric: true, disablePadding: false, label: 'Train Arrival Time' },
  { id: 'Loading Start Time', numeric: true, disablePadding: false, label: 'Loading Start Time' },
  { id: 'Est Loading End Time', numeric: true, disablePadding: false, label: 'Est Loading End Time' },
  ...
  { id: 'Distance to be travelled', numeric: true, disablePadding: false, label: 'Distance to be travelled' },
];
...
export default withStyles(styles)(TrainStatus);
